...
function displaySuccess() {
	...
	pElem.innerText = "You have been log in successfully";
...
function validateLength(elem, min, max) {
	...
	if (value.length < min || value.length > max) {
		...
		displayError(elem, `${elemName} must be between ${min} and ${max}`);
	}
}
...
formElem.addEventListener('submit', validationForm);